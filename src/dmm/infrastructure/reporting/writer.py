...
RMU_FIELDS = [
    ...
    "rmu_db_count", "rmu_db_all_count", "database_unique",
    "diagram_feeder_id", "diagram_feeder_source", "rmu_feeder_id", "rmu_id",
...
RMU_LABELS = {
    ...
    "rmu_status": "状态",
    "rmu_reason": "说明",
    "rmu_db_count": "当前馈线匹配记录数",
    "rmu_db_all_count": "同名数据库记录总数",
    "database_unique": "数据库是否唯一",
    "diagram_feeder_id": "本张G图推断FEEDER_ID",
    "diagram_feeder_source": "本图馈线推断来源",
    "rmu_feeder_id": "环网柜FEEDER_ID（数据库）",
    "rmu_id": "环网柜ID（来源：数据库）",
    "device_count": "G图设备数",
...
RMU_LABELS_EN = {
    ...
    "rmu_status": "Status", "rmu_reason": "Details", "rmu_db_count": "Current Feeder Match Count",
    "rmu_db_all_count": "Total Same-name DB Records", "database_unique": "DB Unique",
    "diagram_feeder_id": "Drawing FEEDER_ID", "rmu_feeder_id": "RMU FEEDER_ID (Database)",
    "diagram_feeder_source": "Drawing Feeder Source",
    ...
    for report in reports:
        ...
        for rmu in rmu_results:
            ...
            row = {
                ...
                "diagram_feeder_source": rmu.get("diagram_feeder_source", "NO"),
